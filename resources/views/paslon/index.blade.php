        ...
        <div class="row">
          <div class="col-sm-8">
            <div class="form-group row">
                ...
                <label class="col-sm-3 col-form-label">Nama Calon:</label>
                <div class="col-sm-9">
                ...
                <label class="col-sm-3 col-form-label">Nama Partai :</label>
                <div class="col-sm-9">
                    <input type="text" id="partai" class="form-control form-control-sm" required>
                </div>
  
                <label class="col-sm-3 col-form-label">No Urut :</label>
                <div class="col-sm-9">
                    <input type="number" id="no_urut" class="form-control form-control-sm" required>
                </div>
